...
<!--ADD QUERY -->
    ...
    <asp:TextBox ID="AddQuerytxt" class="form-control" placeholder="Ask everything to everyone" runat="server"></asp:TextBox>
    ...
    <span class="input-group-addon" id="sizing-addon4">Your Hashtag</span>
        <asp:TextBox ID="AddHashtagtxt" class="form-control" placeholder="Write one hashtag" runat="server"></asp:TextBox>
